...
public class PeopleSelectByWrapperMapperTest {
    ...
    public void selectOne() {
        ...
        queryWrapper.like("name", "le").between("age", 20, 30).isNotNull("email");
        /*
         * selectOne()只能是返回one；
    ...
    public void selectCount() {
        QueryWrapper<People> queryWrapper = new QueryWrapper<>();
        //只有右边有通配符"王%",说明是姓氏
        queryWrapper.likeRight("name", "S").or().ge("age", 40).orderByDesc("age").orderByAsc("id");
...
//        peopleList.forEach(System.out::println);
    ...
    public void selectMaps() {
         ...
         */
        queryWrapper.likeRight("name", "大").and(wq -> wq.lt("age", 45).or().isNotNull("email"));
